...
// Sales pages require a signed-in seller so shipment updates are tied to an account
...
// Keep escrow states current before sellers review or update their orders
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['transaction_id'])) {
    ...
    if (isset($_POST['mark_fulfilled'])) {
        // Fulfillment releases escrow and completes the matching seller-owned transaction
        ...
        // Save shipment details with an upsert so sellers can correct courier or tracking information
...
// Fetch each sale with buyer and shipment details for the seller's order management table
